...
if($_POST){
    if($_POST["id"]==0){
        Product::insert($_POST["naziv"],$_POST["kolicina"],$_POST["cijena"],$_POST["kategorijaid"]);
    ...
    {
        //za update
        Product::update($_POST["id"],$_POST["naziv"],$_POST["kolicina"],$_POST["cijena"],$_POST["kategorijaid"]);
